    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 bg-gray-100 flex items-center justify-center p-6 sm:p-12">
            <div class="w-full max-w-md">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-2 text-center">Atur Password Baru</h2>
                <p class="text-gray-600 mb-8 text-center">Silakan masukkan password baru Anda.</p>
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div class="relative mb-4">
                        ...
                        <x-text-input id="email" class="block w-full pl-10" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" placeholder="Email" />
