...
<div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
    {{-- Hapus atau ganti link dashboard jika tidak diperlukan --}}
    {{-- <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
        {{ __('Dashboard') }}
    </x-nav-link> --}}

    {{-- TAMBAHKAN TIGA LINK INI --}}
    <x-nav-link :href="route('maps.index')" :active="request()->routeIs('maps.index')">
        {{ __('Lihat Maps') }}
    </x-nav-link>
    <x-nav-link :href="route('camera.index')" :active="request()->routeIs('camera.index')">
        {{ __('Lihat Kamera') }}
    </x-nav-link>
...
<div class="pt-2 pb-3 space-y-1">
    ...
    <x-responsive-nav-link :href="route('camera.index')" :active="request()->routeIs('camera.index')">
        {{ __('Lihat Kamera') }}
    </x-responsive-nav-link>
